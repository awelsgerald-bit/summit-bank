...
import { Anchor, Users, Receipt, Clock, LogOut, ShieldCheck, HandCoins, CreditCard, ShieldAlert, AlertTriangle, Bitcoin } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/admin/wallet-applications', label: 'Wallets', icon: Bitcoin },
];
